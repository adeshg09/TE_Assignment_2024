...
export default function ProjectTable({ projects, isLoading }) {
  ...
  return (
    <div className="w-full overflow-auto">
      <Table className="rounded-lg overflow-hidden text-center">
        <TableHeader className="bg-gray-100 rounded-t-lg">
          <TableRow>
            {TableHeaders?.map((item, idx) => (
              <TableHead key={idx} className="w-[200px] text-center px-4 py-2  text-black text-sm font-bold ">
                {item}
              </TableHead>
            ))}
          </TableRow>
          ...
          {isLoading ? (
            ...
            projects?.map((project, idx) => (
              <TableRow key={idx} className="text-center">
                ...
                <TableCell className="px-4 py-2">{project?.description}</TableCell>
                ...
                <TableCell className="px-4 py-2">{project?.noOfMembers}</TableCell>
                <TableCell className="px-4 py-2">
